    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="m-b-15">
                    <form id="search_form">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="s_name">Mobile</label>
                                <input type="text" class="form-control" id="s_name" placeholder="Name">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="s_status">Status</label>
                                <select data-select2-id="status" class="form-control select2-hidden-accessible basic" id="s_status" tabindex="-1"
                                    aria-hidden="true">
                            ...
                            <div class="form-group col-md-3">
                                <label for="s_status">Counties</label>
                                <select data-select2-id="countries" class="form-control select2-hidden-accessible basic" id="s_status" tabindex="-1"
                                    aria-hidden="true">
                                    <option value="">Choose</option>
                                    <option value="1">Active</option>
                                    <option value="0">Inactive</option>
                            ...
                            <div class="form-group col-md-3">
                                <label for="s_status">Cities</label>
                                <select data-select2-id="cities" class="form-control select2-hidden-accessible basic" id="s_status" tabindex="-1"
                                    aria-hidden="true">
                                    <option value="">Choose</option>
                                    <option value="1">Active</option>
                                    <option value="0">Inactive</option>
                ...
                <div class="m-b-15">
                    <a href="{{ route('admins.create') }}" id="info" class="btn btn-primary"><i

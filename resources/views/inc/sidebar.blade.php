        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb')
                    ...
                    {{-- Smart Decisions --}}
                    <li
                        onclick="window.location.href = '{{ route('smartDetactions') }}' "
                        class="menu {{ $category_name === 'smart-decisions' ? 'active' : '' }}">
                        <a href="{{ route('smartDetactions') }}"
                            data-active="{{ $category_name === 'smart-decisions' ? 'true' : 'false' }}"
                            data-toggle="collapse"
                            aria-expanded="{{ $category_name === 'smart-decisions' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                    ...
                    <li
                        onclick="window.location.href = '{{ route('countries.index') }}' "
                        class="menu {{ $category_name === 'smart-decisions' ? 'active' : '' }}">
                        <a href="{{ route('smartDetactions') }}"
                            data-active="{{ $category_name === 'smart-decisions' ? 'true' : 'false' }}"
                            data-toggle="collapse"
                    ...
                    <li class="menu {{ $category_name === 'users' ? 'active' : '' }}">
                        <a href="#users" data-active="{{ $category_name === 'users' ? 'true' : 'false' }}"
                            data-toggle="collapse"
                            aria-expanded="{{ $category_name === 'users' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled {{ $category_name === 'users' ? 'show' : '' }}"
                            ...
                            <li class="{{ $page_name === 'city' ? 'active' : '' }}">
                                <a href="{{ route('cities.index') }}"> Customers </a>
                            </li>
                        </ul>
                    </li>
                    {{-- End users --}}
            ...
            {{-- <li class="menu {{ $category_name === 'bootstrap_basic_table' ? 'active' : '' }}">
                ...
                @else
                    ...
                    {{-- <li
                        class="menu {{ $category_name === 'starter_kits' ? 'active' : '' }}">
